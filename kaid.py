...
if __name__ == '__main__':
    ...
    if para_dict['vis_check']:
        ...
        if para_dict['vis_method'] == 'np':
            ...
            t2_lf = torch_low_pass_filter(t2_kspace, radius=5)
            pd_lf = torch_low_pass_filter(pd_kspace, radius=5)
            ...
            t2_lf_abs = torch_scaling_kspace(t2_hf)
            pd_lf_abs = torch_scaling_kspace(pd_hf)
            ...
            t2_lf_abs = bchw_to_np(t2_lf_abs)
            pd_lf_abs = bchw_to_np(pd_lf_abs)
            ...
            plt.subplot(254)
            plt.imshow(pd_lf_abs, cmap='gray')
            plt.xticks([])
            plt.yticks([])
            plt.title('lf')
            ...
            plt.subplot(259)
            plt.imshow(t2_lf_abs, cmap='gray')
            plt.xticks([])
            plt.yticks([])
            plt.title('lf')
